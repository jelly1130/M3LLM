...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        if self.mix:
            if self.mix_embeds_type in ['v1', 'v5', 'v6', 'v7', 'v8', 'v9', 'v10', 'v11']:
                if self.mix_embeds_type in ['v1', 'v6', 'v8', 'v9', 'v10', 'v11']:
